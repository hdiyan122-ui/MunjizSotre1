...
class AdminDashboard {
    ...
    loadData() {
        ...
        // Load click stats
        this.clickStats = JSON.parse(localStorage.getItem('munjizClickStats')) || {
            total: 0,
            today: 0,
            week: 0,
            month: 0,
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        ...
                        <button class="action-btn" onclick="dashboard.deleteProduct(${product.id})" style="color: #ef4444; border-color: #ef4444;">Delete</button>
                    </div>
                </td>
            </tr>
        `).join('');
